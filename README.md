# ENG417A-FinalProjectGreenlandic
Code used for Oqarpunga: A Hybrid Translation System for the Translation of Greenlandic (Kalaallisut) Verbs 

## Installation: 
Use the command mamba env create -f environment.yaml to set up the necessary virtual environment.

## Description: 
This code uses a hybrid translation system for Greenlandic verbs. It consists of an LLM to convert dictionary entries into usable templates,
